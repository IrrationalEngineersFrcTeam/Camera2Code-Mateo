...
class FineContoursLine:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [43.70503597122301, 113.95904436860067]
        self.__hsv_threshold_saturation = [0.0, 237.5938566552901]
        self.__hsv_threshold_value = [245.36870503597123, 255.0]
    ...
    def __find_lines(input):
        ...
        if len(lines) != 0:
            for i in range(1, len(lines[0])):
                tmp = FineContoursLine.Line(lines[0][i, 0][0], lines[0][i, 0][1],
